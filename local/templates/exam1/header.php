   ...
   $assets->addCss(SITE_TEMPLATE_PATH . "/css/style.css");
    ...
    $assets->addString('<meta name="viewport" content="width=device-width, initial-scale=1.0">');
     $assets->addString('<meta name="author" content="">');
      $assets->addString(' <link rel="icon" type="' . SITE_TEMPLATE_PATH . '/image/vnd.microsoft.icon"  href="' . SITE_TEMPLATE_PATH . '/img/favicon.ico" >');
...
<body>
	...
	array(
		...
		"SITE_ID" => "s2",
		"START_FROM" => "0",
		"COMPONENT_TEMPLATE" => "top_breadcrumb"
	),
	false
);?><br>
