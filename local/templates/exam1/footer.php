<?if(!defined("B_PROLOG_INCLUDED") || B_PROLOG_INCLUDED!==true)die();?>
   ...
   <!-- side -->
                ...
                <div class="side">
                	<? if ($APPLICATION->GetCurPage(false) != '/furniture/'): ?>
                	 <!-- side menu -->
	...
	array(
		...
		"EDIT_TEMPLATE" => "sec_inc_footer_info_company.php",
		"COMPONENT_TEMPLATE" => ".default",
		"PATH" => SITE_TEMPLATE_PATH."/include/sec_inc_footer_info_company.php"
	),
	false
);?>
  ...
  <!-- footer -->
	...
	array(
		...
		"EDIT_TEMPLATE" => "sect_footer_tel.php",
		"COMPONENT_TEMPLATE" => ".default",
		"PATH" => SITE_TEMPLATE_PATH."/include/sect_footer_tel.php"
	),
	false
);?><br>
